...
\noindent
Dans tout ce chapitre, soit $\mathbb{K}$ désigne $\R$ ou $\C$.
 
\section{Généralités}
\subsection{Définitions et premières propriétés}

\begin{definition}
    Une \emphindex{algèbre de Lie} $\mathfrak{g}$ est un $\mathbb{K}$-espace vectoriel munie d'une application bilinéaire $\mathfrak{g}\times \mathfrak{g} \to \mathfrak{g}$, notée $(x,y) \mapsto [x, y]$ et appelée \emphindex{crochet de Lie}, vérifiant:
    \ilist{
...
\begin{definition}
    Soit $I$ un idéal de $\mathfrak{g}$. L'\emphindex{algèbre de Lie quotient} $\mathfrak{g}/I$ est le $\mathbb{K}$-espace vectoriel quotient muni du crochet de Lie
    $$[x+I, y+I] = [x,y]+I$$
...
\begin{definition}
    La \emphindex{somme directe} de deux algèbres de Lie $\mathfrak{g}$ et $\mathfrak{h}$ est le $\mathbb{K}$-espace vectoriel $\mathfrak{g} \times \mathfrak{h}$ muni du crochet de Lie
...
\begin{definition}
    Soit $A$ un $\mathbb{K}$-espace vectoriel muni d'une application bilinéaire $\mu : A \times A \to A$. Une \emphindex{dérivation} de $(A, \mu)$ est une application linéaire $\delta : A \to A$ vérifiant la règle de Leibniz :
...
\begin{definition}
    Soit $\mathfrak{g}$ une algèbre de Lie complexe. Une \emphindex{forme réelle} de $\mathfrak{g}$ est une sous-algèbre de Lie réelle $\mathfrak{h} \subset \mathfrak{g}^{\R}$ telle que
...
\begin{definition}
    L'\emphindex{algèbre de Lie générale} est l'algèbre de Lie $\mathfrak{gl}(n, \mathbb{K})$ des matrices carrées $\mathcal{M}(n, \mathbb{K})$ munie du crochet de Lie
    $$[X, Y] = XY - YX$$
\end{definition}

\begin{definition}
    L'\emphindex{algèbre de Lie spéciale linéaire} est la sous-algèbre de Lie
    $$\mathfrak{sl}(n, \mathbb{K}) = \ker(\tr) = \{ X \in \mathfrak{gl}(n, \mathbb{K}) \mid \tr(X) = 0 \}$$
\end{definition}

\begin{definition}
    L'\emphindex{algèbre de Lie symplectique} est la sous-algèbre de Lie
    $$\mathfrak{sp}(2n, \mathbb{K}) = \left\{ X \in \mathfrak{gl}(2n, \mathbb{K}) \mid \transpose{X} J + J X = 0 \right\}$$
...
\begin{definition}
    L'\emphindex{algèbre de Lie unitaire} est l'algèbre de Lie réelle
    $$\mathfrak{u}(n) = \{ X \in \mathfrak{gl}(n, \C) \mid X^\dagger + X = 0 \}$$
    où $X^\dagger = \transpose{{\overline{X}}}$ désigne le conjugué hermitien. L'\emphindex{algèbre de Lie spéciale unitaire} est la sous-algèbre de Lie réelle
...
\begin{theorem}
    Soit $\mathfrak{g}$ une sous-algèbre de $\mathfrak{gl}(V)$, où $V$ est un $\mathbb{K}$-espace vectoriel de dimension finie, telle que $\tr(xy)=0$ pour tout $x\in [\mathfrak{g}, \mathfrak{g}]$ et tout $y\in\mathfrak{g}$. Alors $\mathfrak{g}$ est résoluble.
\end{theorem}
...
\begin{definition}
    Une \emphindex{algèbre de Lie simple} est une algèbre de Lie $\mathfrak{g}$ dont le centre est trivial et qui ne possède aucun idéal autres que $0$ et elle-même.
\end{definition}
