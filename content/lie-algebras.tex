...
\begin{definition}
    Une \emph{extension} d'une algèbre de Lie $\mathfrak{k}$ par une algèbre de Lie $\mathfrak{h}$ est une algèbre de Lie $\mathfrak{g}$ telle qu'on ait la suite exacte courte d'algèbres de Lie
    \begin{diag}
    0 \arrow[r] & \mathfrak{h}  \arrow[r, "i"] & \mathfrak{g}  \arrow[r, "\pi"] & \mathfrak{k}  \arrow[r] & 0
    \end{diag}
    L'extension est dite \emph{triviale} s'il existe un isomorphisme $\varphi : \mathfrak{g} \to \mathfrak{h} \oplus \mathfrak{k}$ tel que le diagramme suivant commute
    \begin{diag}
        {} & {} & \mathfrak{g} \arrow[rd, "\pi"] \arrow[dd, "\varphi"] & {} & {} \\
        0 \arrow[r] & \mathfrak{h} \arrow[ru, "i"] \arrow[dr, "\iota_1"'] &  & \mathfrak{k} \arrow[r] & 0 \\ 
        & & \mathfrak{h}\oplus \mathfrak{k} \arrow[ur, "\pi_2"'] & &
    \end{diag}
    L'extension est dite \emph{scindée} s'il existe un morphisme $s : \mathfrak{k} \to \mathfrak{g}$ tel que 
    \begin{diag}
    0 \arrow[r] & \mathfrak{h}  \arrow[r, "i"] & \mathfrak{g}  \arrow[r, "\pi"] & \mathfrak{k}  \arrow[r]\arrow[l, dashed, "s", bend left] & 0
    \end{diag}
    L'extension est dite \emph{centrale} si $i(\mathfrak{h}) \subset \mathcal{Z}(\mathfrak{g})$.
\end{definition}
